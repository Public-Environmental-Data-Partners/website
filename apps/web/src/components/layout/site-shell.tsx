 ...
 * Geometry: docs/architecture/layout-system.md — max width + padding from CSS vars in globals.css.
 */
const siteShellVariants = cva('mx-auto w-full max-w-site', {
  variants: {
    padding: {
       ...
       * See docs/architecture/layout-system.md — Grid box vs viewport inset.
       */
      grid: [
        'px-[var(--site-padding-x)]',
