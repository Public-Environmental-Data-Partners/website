...
/** Shared image + credit + caption fields for in-body figure items. */
export const articleFigureItem = defineType({
  name: 'articleFigureItem',
  title: 'Figure',
  type: 'object',
  fields: [
    defineField({
  ...
  preview: {
    ...
    prepare({media, photoCredit}) {
      ...
      return {
        title: 'Figure',
        subtitle: credit ? `PHOTO CREDIT: ${credit}` : 'Image',
        media,
      }
    },
  },
